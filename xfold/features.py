...
from xfold.constants import chemical_components
from xfold.constants import mmcif_names
from xfold.constants import periodic_table
...
class MSA:
    ...
    def index_msa_rows(self, indices: np.ndarray) -> Self:
...
class TokenFeatures:
    ...
    is_nonstandard_polymer_chain: np.ndarray
    is_water: np.ndarray
...
class PredictedStructureInfo:
    ...
    atom_mask: np.ndarray
    residue_center_index: np.ndarray
